...
import com.example.comictracker.presentation.ui.screens.aboutScreens.aboutCharacter.CharacterScreen
import com.example.comictracker.presentation.ui.screens.aboutScreens.aboutComic.ComicScreen
import com.example.comictracker.presentation.ui.screens.aboutScreens.aboutSeries.AllComicSeriesSec
import com.example.comictracker.presentation.ui.screens.aboutScreens.aboutSeries.SeriesScreen
import com.example.comictracker.presentation.ui.screens.homeScreen.HomeScreen
import com.example.comictracker.presentation.ui.screens.libaryScreen.LibraryScreen
import com.example.comictracker.presentation.ui.screens.searchScreen.AllCharactersScreen
import com.example.comictracker.presentation.ui.screens.searchScreen.SearchResultScreen
...
fun AppNavigation(innerPadding: PaddingValues, navController: NavHostController){
    ...
    NavHost(
        ...
        composable("comics_from_series/{seriesId}/{loadCount}"){
            val seriesId = it.arguments!!.getString("seriesId")
            val loadCount = it.arguments!!.getString("loadCount")
            AllComicSeriesSec(seriesId!!.toInt(),loadCount = loadCount!!.toInt(), navController = navController) }

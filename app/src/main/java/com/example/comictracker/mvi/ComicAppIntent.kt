...
sealed class ComicAppIntent {
    ...
    data class MarkAsReadComic(val comicId:Int,val seriesId: Int): ComicAppIntent()
    data class MarkAsUnreadComic(val comicId:Int,val seriesId: Int): ComicAppIntent()
